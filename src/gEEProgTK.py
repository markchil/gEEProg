...
HELP_TEXT = {
    "2801Prog": "This is a 2801Prog.",
    "2006Prog": "This is a 2006Prog."
}
...
class ControlBox(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.swap_button.grid(row=0, column=0, sticky='W')
        ...
        self.program_button.grid(row=2, column=0, sticky='W')
        self.verify_button = tk.Button(
            self,
            text="verify",
            command=self.master.verify
        )
        self.verify_button.grid(row=3, column=0, sticky='W')
        self.erase_button = tk.Button(
            self,
            text="erase",
            command=self.master.erase
        )
        self.erase_button.grid(row=4, column=0, sticky='W')
